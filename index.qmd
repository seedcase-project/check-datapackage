...
-   Checks the
    [descriptor(s)](https://datapackage.org/standard/glossary/#descriptor)
    in your `datapackage.json` against the Data Package standard.
-   Enables you to configure which components of the descriptor(s) that
