...
# {{< meta gh.repo >}}: Ensure compliance of your Data Package to the standard
...
Package standard---it does not check the data itself against the
metadata. Specifically, it:
