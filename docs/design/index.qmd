...
(i.e., maintainable in the long term) and to ensure that
the team has a shared understanding of the package's scope and architecture before starting the development.
...
-   Check Data Package descriptors against the Data Package standard, specifically the Data Package [profiles](https://datapackage.org/standard/glossary/#profile).
...
-   Support custom, user-defined checks in addition to those in the
    standard.
-   Provide clear, user-friendly, and structured messages about
    any issues, identifying where in the descriptor the issues occur.
-   Provide a strict mode that enforces all aspects of the Data
    Package standard, including all recommendations.
