...
against the [Data Package standard](https://datapackage.org/). The
contents of the descriptor (the `datapackage.json`) are called
...
-   Provide clear, user-friendly, and structured messages about any
    issues, identifying which properties the issues occur in.
