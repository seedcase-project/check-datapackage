...
`check-datapackage` is a simple Python package that checks your
[Data Package's](https://datapackage.org) `datapackage.json` file for
compliance with the
[Data Package specification](https://datapackage.org/standard/data-package/).
...
on the [Frictionless](https://frictionlessdata.io/universe/) and
...
Since we found ourselves missing a tool we needed for our
...
- [How-to guide](/docs/guide/index.qmd): The guide section provides a
  step-by-step introduction to `check-datapackage`, including installing
  and using it.
- [Reference](/docs/reference/index.qmd): The reference section contains
  detailed information about the `check-datapackage` API, specifically
  the documentation of individual classes and functions.
