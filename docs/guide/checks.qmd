...
+-+---------------- 1 ----------------
| check_datapackage.check_error.CheckError: Error at `$.description` caused by `required`: 'description' is a required property
+---------------- 2 ----------------
| check_datapackage.check_error.CheckError: Error at `$.resources[0].description` caused by `required`: 'description' is a required property
+------------------------------------
```
...
-   "check_datapackage.check_error.CheckError": the class
