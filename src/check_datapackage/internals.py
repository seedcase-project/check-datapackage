...
class SchemaError:
    ...
    Attributes:
        ...
        validator (str): The type of the error.
        schema_path (str): The path to the violated rule in the JSON schema.
            Path components are separated by '/'.
        json_path (str): The JSON path to the field that violates the rule.
    ...
    if path_or_data_required_errors:
        ...
        schema_errors.append(
            SchemaError(
                ...
                validator="required",
                json_path=parent_error.json_path,
    ...
    if only_type_errors:
        schema_errors.append(
            SchemaError(
                ...
                validator="type",
                json_path=type_errors[0].json_path,
...
def _path_or_data_required_error(error: SchemaError) -> bool:
    return error.json_path.endswith(("path", "data")) and error.validator == "required"


def _is_path_type_error(error: SchemaError) -> bool:
    return error.validator == "type" and error.json_path.endswith("path")
